...
Namespace Deliveryschedule
    ...
    Public Class Deliveryschedule
        ...
        Public Shared Sub Main()
            ...
            'Dim UserFieldsMD As UserFieldsMD
            ...
            Try
                ...
                '    Dim addOnDb As Deliveryschedule_Db = New Deliveryschedule_Db()
                '    addOnDb.Add(B1Connections.diCompany)
                '    Dim addOnCockpit As Deliveryschedule_Cockpits = New Deliveryschedule_Cockpits()
                ...
                'CREATE ADD-ON
                Dim addOn As Deliveryschedule = New Deliveryschedule()
