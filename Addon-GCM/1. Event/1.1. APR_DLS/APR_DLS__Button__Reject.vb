...
Imports SAPbobsCOM
Imports SAPbouiCOM
Public Class APR_DLS__Button__Reject
    Inherits B1Item
    ...
    Public Overridable Sub OnAfterItemPressed(ByVal pVal As ItemEvent)
        ...
        Try
            ...
            For brs = 0 To Grid.Rows.SelectedRows.Count - 1
                ...
                Dim sql As String = "update ""@ODLS"" set ""U_IDU_Appr_Status""='R', ""Remark""='" & remark & "' where ""DocEntry""=" & Docentry & " and ""U_IDU_Appr_Status"" = 'W' "
